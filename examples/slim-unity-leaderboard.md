...
| [unity-sds](https://github.com/unity-sds) | [unity-docs](https://github.com/unity-sds/unity-docs) | 🅿️ | 🅿️ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌
| [unity-sds](https://github.com/unity-sds) | [unity-cs-sps-demo](https://github.com/unity-sds/unity-cs-sps-demo) | 🅿️ | 🅿️ | ✅ | ✅ | ✅ | 🅿️ | ❌ | ❌
...
| [unity-sds](https://github.com/unity-sds) | [unity-cs-security](https://github.com/unity-sds/unity-cs-security) | 🅿️ | 🅿️ | 🅿️ | 🅿️ | 🅿️ | 🅿️ | ❌ | ❌
...
- Proposed PR Count: the total number of best practices that are currently in proposal state as open pull-requests to code repositories
- Proposed Issues Count: the total number of best practices that are currently in proposal state as open issue tickets to code repositories
