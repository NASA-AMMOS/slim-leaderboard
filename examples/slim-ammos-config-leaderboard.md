...
| Category | Score (%) |
| ------ | ----- |
| Additional Documentation | 62.9 |
| License | 54.9 |
| Readme | 47.4 |
| Code of Conduct | 36.3 |
| Contributing Guide | 32.5 |
| Issue Templates | 28.4 |
| Changelog | 28.1 |
| PR Templates | 24.0 |
| Governance Model | 8.2 |
| GitHub: Vulnerability Alerts | 2.1 |
| GitHub: Code Scanning Alerts | 2.1 |
| GitHub: Secret Scanning Alerts | 1.0 |
| Secrets Detection | 1.0 |
| Continuous Testing Plan | 0.5 |


**Overall Repository Average Score (%)**: 23.5
